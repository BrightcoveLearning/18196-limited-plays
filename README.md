...
# 18196-limited-plays
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-limited-plays.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>limited-plays.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>limited-plays.css</strong>.</td>
    </tr>
  </tbody>
</table>
